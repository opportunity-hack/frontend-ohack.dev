    ...
    return (
      ...
      >
        ...
        <Typography variant="body2" color="text.secondary" paragraph>
          Tap a card to add it. Pick at least {MIN_SELECTIONS} — they appear in
          your ranked list above as you go, where you can drag them into your
          order of preference.
        </Typography>
        ...
        {filteredNonprofits.length > 0 ? (
          <Grid container spacing={2}>
            {filteredNonprofits.map((nonprofit) => {
              const isSelected = selectedNonprofits.some(
                (np) => np.id === nonprofit.id,
              );
                    ...
                    <CardContent>
                      ...
                      >
                        {nonprofit.description ||
                          "Join this nonprofit's mission to make a positive social impact."}
                      </Typography>
                        ...
                        nonprofit.problem_statements.length > 0 && (
                          <Box>
                            ...
                            >
                              {nonprofit.problem_statements
                                .filter(
                                  (problem) => problem.status !== "production",
                                )
                                .map((problem, idx) => (
                                  <Chip
                                    key={idx}
          ...
          <Alert severity="info" sx={{ my: 2 }}>
            {searchTerm
              ? "No nonprofits match your search. Try different keywords."
