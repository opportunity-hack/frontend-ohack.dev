  ...
  return (
    <Box>
      ...
      <Typography variant="body1" paragraph>
        Your team will be working to create tech solutions that directly impact these amazing organizations.
        First select the nonprofits you're interested in, then rank them in your order of preference!
      </Typography>
        ...
        <Box sx={{ display: 'flex', mb: 3 }}>
          ...
          <Button 
            ...
            sx={{ 
              ...
              opacity: (rankingMode === 'rank' || selectedNonprofits.length === 0) ? 1 : 0.7
            }}
          >
