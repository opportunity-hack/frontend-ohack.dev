 ...
 */
const NonprofitRanker = memo(
  ({ selectedNonprofits, handleDragEnd, onRemove }) => {
    return (
      <Box
        sx={{
          p: 3,
      ...
      >
        ...
        <Typography variant="body2" color="text.secondary" paragraph>
          Drag to reorder — <strong>#1 at the top is your top choice</strong>.
          Add or remove nonprofits anytime from the list below.
        </Typography>
        ...
        {selectedNonprofits.length > 0 ? (
                              ...
                              <Box flexGrow={1}>
                                ...
                                {nonprofit.problem_statements &&
                                  nonprofit.problem_statements.length > 0 && (
                                    ...
                                    >
                                      {nonprofit.problem_statements.map(
                                        (problem, idx) => (
                                          <Chip
                                            key={idx}
          ...
          <Alert severity="warning" sx={{ my: 2 }}>
            No nonprofits selected. Please go back and select at least one
            nonprofit.
          </Alert>
        )}
      </Box>
