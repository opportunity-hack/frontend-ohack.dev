  ...
  return (
    <LayoutContainer key="mentorship" container>
      ...
      <TitleContainer container>
        ...
        >
          Share your expertise to help teams create meaningful technology
          solutions that make a real difference. As a mentor, you'll guide
          participants through technical challenges, strategic decisions, and
          product development while helping nonprofits achieve their missions
          through technology.
        </Typography>
      ...
      <Box sx={{ textAlign: "center", mb: 5 }}>
        ...
        >
          Mentor providing hands-on guidance to help teams build impactful
          solutions
        </Typography>
      </Box>
      ...
      <ProjectsContainer style={{ marginTop: 20 }}>
        ...
        <Paper
          sx={{ p: 4, mb: 5, bgcolor: "secondary.light", color: "white" }}
          id="upcoming-events"
        >
          <Typography
            variant="h3"
          ...
          >
            Join one of our upcoming hackathons as a mentor and make a direct
            impact on nonprofit technology solutions.
          </Typography>
        ...
        <Box sx={{ mb: 5 }}>
          ...
          >
            Mentoring at Opportunity Hack is more than volunteering—it's about
            using your professional skills to create lasting social impact.
          </Typography>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={4}>
              <Card sx={{ textAlign: "center", height: "100%", p: 3 }}>
                ...
                <Typography variant="body1">
                  Guide teams creating solutions that nonprofits actually
                  implement to help their communities
                </Typography>
              </Card>
            </Grid>
            <Grid item xs={12} md={4}>
              <Card sx={{ textAlign: "center", height: "100%", p: 3 }}>
                ...
                <Typography variant="body1">
                  Enhance your mentoring and leadership skills while helping the
            ...
            <Grid item xs={12} md={4}>
              <Card sx={{ textAlign: "center", height: "100%", p: 3 }}>
                ...
                <Typography variant="body1">
                  Connect with passionate developers, designers, and nonprofits
        ...
        <Box sx={{ mb: 5 }}>
          ...
          >
            We welcome mentors from all technical backgrounds. Choose the area
            that best matches your expertise and interests.
          </Typography>
        ...
        <Alert severity="info" sx={{ mb: 5 }}>
          ...
          <Typography variant="body1">
            By tracking your volunteer hours as a mentor, you or your company
            can be recognized as an Opportunity Hack sponsor! Learn more about
            how your time investment creates value for everyone.
          </Typography>
          <Box sx={{ mt: 2 }}>
            <Button
              variant="outlined"
        ...
        <Box sx={{ textAlign: "center", mb: 5 }}>
          ...
          >
            Join our community of mentors using their expertise to create
            technology solutions that help nonprofits change the world.
          </Typography>
