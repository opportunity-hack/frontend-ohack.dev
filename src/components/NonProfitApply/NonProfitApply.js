...
import { FormContainer } from "../../styles/nonprofits/apply/styles";
...
export default function NonProfitApply() {
  ...
  let { nonprofits, handle_get_npo_form, handle_npo_form_submission } =
    useNonprofit();
  ...
  var loginCallToAction = (
    <LoginOrRegister
      introText={
        "Please consider logging in or creating an account. You'll need a Slack account for the hackathon."
      }
          ...
          {!loading && formSubmissionDate && (
            <Alert severity="success">
              <h4>
                ...
                {Moment(formSubmissionDate.toLocaleString()).format(
                  "MMMM Do YYYY @ hh:mma"
                )}
              </h4>
              <div className={"image-container"}>
                <Image
                  src={
                    "https://media0.giphy.com/media/k6r6lTYIL9j9ZeRT51/giphy.gif"
                  }
                  layout="responsive"
                  width="320"
                  height="266"
      ...
      <FormContainer>
        <DetailsContainer container>
          <DescriptionStyled>
            ...
            <Alert severity="warning">
              <Typography style={style}>
                ...
                <br />
                Your time is commitment is 10-20 hours over the course of the
                weekend, and a few hours of prep work before the event.
                <br />
                Winning teams will be invited to continue working on their
                projects after the hackathon is over and this typically takes 3
                months.
              </Typography>
              <br />
              <br />
              <FormControlLabel
                ...
                label={
                  <Typography style={style}>
                    I understand that not all projects will be completed after
          ...
          >
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.areasOfFocus &&
                        formState.areasOfFocus.includes("Economic Empowerment")
                      }
                    />
                  }
                  label={
                    <Typography style={style}>Economic Empowerment</Typography>
                  }
                />
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.areasOfFocus &&
                        formState.areasOfFocus.includes("Education")
                      }
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.areasOfFocus &&
                        formState.areasOfFocus.includes("Animals")
                      }
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.areasOfFocus &&
                        formState.areasOfFocus.includes(
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.areasOfFocus &&
                        formState.areasOfFocus.includes("Career Mentoring")
                      }
                    />
                  }
                  label={
                    <Typography style={style}>Career Mentoring</Typography>
                  }
                />
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.areasOfFocus &&
                        formState.areasOfFocus.includes("Arts & Culture")
                      }
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.areasOfFocus &&
                        formState.areasOfFocus.includes("Other areas")
                      }
                    />
                  }
            ...
            <DescriptionStyled>
              <b>
                Does your organization or program serve a majority (51% or more)
                of any of the following populations?
              </b>
              <FormGroup>
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.servedPopulations &&
                        formState.servedPopulations.includes("Women")
                      }
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.servedPopulations &&
                        formState.servedPopulations.includes("Black")
                      }
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.servedPopulations &&
                        formState.servedPopulations.includes("Indigenous")
                      }
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.servedPopulations &&
                        formState.servedPopulations.includes("Asian")
                      }
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.servedPopulations &&
                        formState.servedPopulations.includes("LatinX")
                      }
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.servedPopulations &&
                        formState.servedPopulations.includes("Disabled")
                      }
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.servedPopulations &&
                        formState.servedPopulations.includes("LGBTQUIA+")
                      }
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.servedPopulations &&
                        formState.servedPopulations.includes("Veterans")
                      }
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.servedPopulations &&
                        formState.servedPopulations.includes(
                          "Immigrants/ Refugees"
                        )
                      }
                    />
                  ...
                  label={
                    <Typography style={style}>Immigrants/Refugees</Typography>
                  }
                />
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={
                        formState.servedPopulations &&
                        formState.servedPopulations.includes("Other")
                      }
                    />
                  }
        ...
        <DetailsContainer container>
          <DescriptionStyled>
            ...
            <br />
            <Typography style={style}>
              We use Slack as our only mechanism for communication for
              Opportunity Hack, we ask this question to better understand your
              knowledge of using Slack (see{" "}
              <a
            ...
            <FormControlLabel
              ...
              label={
                <Typography style={style}>I am familiar with Slack</Typography>
              }
            />
          </DescriptionStyled>
        </DetailsContainer>
        ...
        <DetailsContainer container>
          <DescriptionStyled>
            ...
            <Typography style={style}>
              ...
              <br />
              This would include providing an email and phone number for
              questions during times when the staff isn't physically available.
              <br />
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    ...
                    checked={
                      formState.keyStaffAvailability &&
                      formState.keyStaffAvailability.includes(
                ...
                label={
                  <Typography style={style}>
                    They will be available remotely throughout the entire period
                    by <b>phone</b>
                  </Typography>
                }
              />
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    ...
                    checked={
                      formState.keyStaffAvailability &&
                      formState.keyStaffAvailability.includes(yesTextSaturday)
                    }
                    onChange={keyStaffAvailabilitySetState}
                  />
                }
                label={
                  <Typography style={style}>
                    Yes, they will be able to attend for nonprofit presentations
                    the morning of {START_DATE}
                  </Typography>
                }
              />
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    ...
                    checked={
                      formState.keyStaffAvailability &&
                      formState.keyStaffAvailability.includes(yesTextSunday)
                    }
                    onChange={keyStaffAvailabilitySetState}
                  />
                }
                label={
                  <Typography style={style}>
                    Yes, they will be able to attend the final presentations and
                    judging the afternoon of {END_DATE}
                  </Typography>
                }
              />
            </FormGroup>
            ...
            <br />
            <Typography style={style}>
              Are you planning to join us in person at {LOCATION_ARIZONA}?{" "}
              <a
                target="_blank"
                rel="noreferrer"
                style={{ color: "#0000EE", textDecoration: "underline" }}
                href="https://forms.gle/ByDbHo1eqEaxZB1v7"
              >
                Suggest a location for the hackathon here.
              </a>
            </Typography>
            <FormGroup>
              <FormControlLabel
                ...
                label={
                  <Typography style={style}>
                    Yes, either myself or a point of contact from our nonprofit
                    is planning to attend in-person
                  </Typography>
                }
              />
            </FormGroup>
            ...
            <ul>
              <li>
                From now until August: We'll review applications - expect some
                questions sent via email or Slack.
              </li>
              <li>
                September: Nonprofits will be notified, we'll spend a couple
                hours to refine your pitches for the hackathon.
              </li>
              <li>
                October: Hackathon! We meet over a weekend and hackers write
                software to solve your problem.
              </li>
            </ul>
            <Typography variant="body4">
              Still have a problem for us? Submit it! We're a 24x7 platform and
              we always welcome your partnership.
            </Typography>
          </DescriptionStyled>
        </DetailsContainer>
      </FormContainer>
      <DetailsContainer container>
        ...
        <DescriptionStyled>
          ...
          <Typography style={style}>
            ...
            technical problems for public charities, non-profit organizations
            (NPOs), and non-government organizations (NGOs).
          </Typography>
          <br />
          <h4 className="profile__title">
