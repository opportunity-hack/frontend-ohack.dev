...
function OHackFeatures() {
  const details = [
    ...
    },
    {
      ...
      icon: <VolunteerActivismOutlinedIcon style={{ fontSize: "10rem" }} />,
    },
    {
      index: 2,
  ...
  return (
    <BlankContainer container>
      ...
      >
        ...
        >
          <TabStyled
            label={width < 480 ? (value == 0 ? "Impact" : "") : "Impact"}
            {...a11yProps(0)}
            icon={<LibraryAddCheckOutlinedIcon />}
          />
          <TabStyled
            label={
              width < 480 ? (value == 1 ? "Volunteerism" : "") : "Volunteerism"
            }
            {...a11yProps(1)}
          ...
          <TabStyled
            label={
              width < 480 ? (value == 2 ? "Experience" : "") : "Experience"
            }
            {...a11yProps(2)}
            icon={<BuildOutlinedIcon />}
          />
          <TabStyled
            label={width < 480 ? (value == 3 ? "Community" : "") : "Community"}
            {...a11yProps(3)}
            icon={<PeopleAltOutlinedIcon />}
          />
        </TabsStyled>

        <TabContainer container justifyContent="center" alignItems="center">
          <SwipeableViews
          ...
          >
            {details.map((detail) => {
              return (
                <TabPanel value={value} key={detail.title} index={detail.index}>
                  <InfoContainer
                    item
                    lg={12}
                    container
                    ...
                    alignItems="center"
                  >
                    <NormalTextStyled>{detail.description}</NormalTextStyled>
                  </InfoContainer>
                </TabPanel>
              );
            })}
