...
export default function HelpUsBuildOHack({github_link, github_name}) {
        ...
        return (
            <HelpUsBuildOHackContainer>
                ...
                <HelpUsBuildOHackDescription>This portion is a work in progress and, more importantly, this site is open source and we welcome your contributions.  <HelpUsBuildOHackLink href={github_link} target="_blank" >Please see {github_name} for more information</HelpUsBuildOHackLink> </HelpUsBuildOHackDescription>
            </HelpUsBuildOHackContainer>            
        );
    }
