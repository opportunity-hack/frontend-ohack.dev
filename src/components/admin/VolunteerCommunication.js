...
const VolunteerCommunication = ({
  ...
  const filteredTemplates = filterTemplatesByType(volType, templates);

  // Single dialog rendered for both usages (external control and the
  // self-contained card). Previously this JSX was duplicated wholesale.
  const messageDialog = (
    <Dialog
