...
export const SECTIONS = [
  {
    ...
    label: "Overview",
    icon: OverviewIcon,
    hint: "Title, dates, location, image",
    group: "config",
  },
  {
    slug: "schedule",
    label: "Schedule",
    icon: ScheduleIcon,
    hint: "Countdowns and event timeline",
    group: "config",
  },
  {
    slug: "deadlines",
    label: "Deadlines",
    icon: DeadlinesIcon,
    hint: "Submission cutoff, late window, Hackers' Choice voting",
    group: "config",
  },
  {
    slug: "meals",
    label: "Meals",
    icon: MealsIcon,
    hint: "Meal slots and menus for hackers",
    group: "config",
  },
  {
    slug: "participants",
    ...
    hint: "Applications, teams, screening",
    group: "config",
  },
  {
    slug: "judges",
    label: "Judges",
    icon: JudgesIcon,
    hint: "Judging settings and arrival time",
    group: "config",
  },
  {
    slug: "nonprofits",
  ...
  },
  {
    ...
    label: "Planning",
    icon: PlanningIcon,
    hint: "Planning board, Slack, editors",
    group: "config",
  },
  {
    slug: "donations",
    label: "Funding",
    icon: DonationsIcon,
    hint: "Donation totals and goals",
    group: "config",
  },
  {
    slug: "links",
    label: "Links",
    icon: LinksIcon,
    hint: "Buttons shown on the public event page",
    group: "config",
  },
  {
    slug: "volunteer",
    label: "Volunteer admin",
    icon: VolunteerAdminIcon,
    hint: "Mentors, judges, volunteers, hackers, sponsors",
    group: "ops",
  },
  {
    slug: "teams",
    label: "Teams",
    icon: TeamsIcon,
    hint: "Team rosters and nonprofit assignments",
    group: "ops",
  },
  {
    slug: "judging",
    label: "Judging",
    icon: JudgingIcon,
    hint: "Round 1, Round 2, and results",
    group: "ops",
  },
  {
    slug: "checkin",
    label: "Check-in",
    icon: CheckInIcon,
    hint: "QR scan and manual check-in at the event",
    group: "ops",
  },
];
