    ...
    if( user == null )
    {
        loginCallToAction = 
            ...
            <Alert variant="outlined" severity="warning" >
                <AlertTitle>Whoa there - you need to login or create an account first.</AlertTitle>
    ...
    return (
        <div className="content-layout">            
            ...
            <Card sx={{ maxWidth: 445 }}>
                <CardHeader
                    avatar={
                        <Avatar sx={{ bgcolor: red[500] }} aria-label="npo-avatar">
                ...
                <CardMedia
                    component="img"
                    height="194"
                    image="/npo_placeholder.png"
                    alt={nonprofit.name}
                />
                <CardContent>
                    <Typography variant="body2" color="text.secondary">
                        {getWordStr(nonprofit.description)}...
                    </Typography>
                </CardContent>
                ...
                <Collapse in={expanded} timeout="auto" unmountOnExit>
                    <CardContent>
                        ...
                        <Typography paragraph>
                            Looking to get involved? Join the #{slack_details_plain} channel on Slack to join in on the discussion!
                        </Typography>
                    </CardContent>
                </Collapse>
            </Card>
