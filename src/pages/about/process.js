...
export default function OpportunityHackProcess() {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Head>
        <title>
          Opportunity Hack Process: Empowering Nonprofits through Tech
          Innovation
        </title>
        <meta
          name="description"
          content="Discover how Opportunity Hack connects nonprofits with skilled volunteers to solve technological challenges. Learn about our unique hackathon process for social good."
        />
        <meta
          name="keywords"
          content="Opportunity Hack, nonprofit technology, hackathon, tech volunteers, social impact, open source, mentorship, software development, project management"
        />
        <meta
          property="og:title"
          content="Opportunity Hack: Bridging Nonprofits and Tech Innovators"
        />
        <meta
          property="og:description"
          content="Join Opportunity Hack to use your tech skills for social good. Whether you're a nonprofit, developer, designer, or sponsor, learn how you can make a difference."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ohack.dev/about/process" />
        <meta
          property="og:image"
          content="https://ohack.dev/images/opportunity-hack-banner.jpg"
        />
      </Head>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <StyledPaper>
          ...
          <Typography paragraph>
            Opportunity Hack brings together nonprofits, developers, designers,
            and tech professionals to create innovative solutions for social
            good. Here's how we make it happen:
          </Typography>
          ...
          {[
            {
              ...
              content:
                "Nonprofits submit their ideas and challenges through our online form.",
              list: [
            ...
            },
            {
              ...
              content:
                "Our expert team carefully evaluates each application to ensure a good fit.",
              list: [
            ...
            },
            {
              ...
              content:
                "We choose diverse projects that can benefit most from our hackathon model.",
              list: [
            ...
            },
            {
              ...
              content:
                "We work closely with nonprofits to define clear, impactful project goals.",
              list: [
            ...
            },
            {
              ...
              content:
                "The main event where volunteers collaborate intensively on nonprofit projects.",
              list: [
            ...
            },
            {
              ...
              content:
                "We ensure projects have a path forward after the hackathon ends.",
              list: [
          ...
          {[
            {
              ...
              a: (
                <>
                  Sponsors play a crucial role in making Opportunity Hack
                  possible. You can contribute by providing funding, offering
                  mentorship, donating technology resources, or hosting events.
                  Your support directly enables nonprofits to leverage
                  cutting-edge technology for social good.{" "}
                  <Link
                    href="/sponsor"
